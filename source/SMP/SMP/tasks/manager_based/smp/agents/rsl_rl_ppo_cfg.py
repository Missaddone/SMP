...
@configclass
class BodyVelocityLafanRunPPORunnerCfg(PPORunnerCfg):
    experiment_name = "smp_body_velocity_lafan_run_g1"
    run_name = "smp_body_velocity_lafan_run_g1"


@configclass
class BodyVelocityAmpRunPPORunnerCfg(PPORunnerCfg):
    experiment_name = "smp_body_velocity_amp_run_g1"
    run_name = "smp_body_velocity_amp_run_g1"
